...
CREATE TABLE public.teachers (
                                ...
                                "contract_timestamp" timestamp with time zone default current_timestamp,
...
CREATE TABLE public.marks (
                              ...
                              "time" time NOT NULL,
                              CONSTRAINT marks_pk PRIMARY KEY (student,subject,mark,"time")
);


-- public.marks foreign keys

ALTER TABLE public.marks ADD CONSTRAINT marks_fk FOREIGN KEY (student) REFERENCES public.students(id);
ALTER TABLE public.marks ADD CONSTRAINT marks_fk_1 FOREIGN KEY (subject) REFERENCES public.subjects("index");
